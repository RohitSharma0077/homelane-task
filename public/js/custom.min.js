...
$(document).ready(function(){
        $(".owl-carousel .owl-item img").height($(document).height());
});
};
$(document).ready(function(){ 
...
$(document).ready(function(){
    ...
    if ($(window).scrollTop() >= 1) {
        $('.fix-sidebar .left-sidebar').css('position', 'fixed');
    }
    else {
        $('.fix-sidebar .left-sidebar').css('position', 'absolute');
    }
});
